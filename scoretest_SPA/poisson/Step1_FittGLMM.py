...
def Step1_FitGLMM(prefix, Geno, Cell, index, M, family_indicator,
    ...
    sparseGRMFile = "./data/sparseGRM_relatednessCutoff_0.125_1000_randomMarkersUsed.sparseGRM.mtx"
    sparseGRMSampleIDFile = "./data/sparseGRM_relatednessCutoff_0.125_1000_randomMarkersUsed.sparseGRM.mtx.sampleIDs.txt"
